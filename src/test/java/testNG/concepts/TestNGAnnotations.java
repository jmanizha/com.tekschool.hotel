...
public class TestNGAnnotations {
    ...
    //@BeforeMethod: This annotation will be execute before each test method
	//@AfterMethod: This annotation will be execute after each test method
	...
	//@AfterClass: This annotation will executed after class if we have multiple test cases in
	//TestNG:This annotation will execute after each class
	//@BeforeGroup and @AfterGroup: These annotations will be executed before and after set of test cases
	// which are grouped by specific name.
	
	// in Real world we use mainly @Test for each Test case. and @BeforeMethod and @AfterMethod
	// to setup properties and Tear down after each Execution. @BeforeMethod and @AfterMethod are 
