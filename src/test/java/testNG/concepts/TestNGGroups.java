...
public class TestNGGroups {
	...
	// TestNG groups allows us to group certain tests and run them from TestNG.xml (Test Suite)
	// Why we use TestNG Groups?
	// We can group our test cases such as Smoke, Regression and run them from suite regardless of their 
	// class location.
